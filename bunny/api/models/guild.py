...
class GuildFeature(str, Enum):
    ...
    .. note:
        Equivalent of `Guild Features <https://discord.com/developers/docs/resources/guild#guild-object-guild-features>`_ in the senpai API.
    """
...
class WelcomeScreen(DictSerializerMixin):
    ...
    .. note::
        ``description`` is ambiguous -- senpai poorly documented this. :)

        We assume it's for the welcome screen topic.

    :ivar typing.Optional[str] description: The description of the welcome sceen.
    :ivar typing.List[bunny.api.models.guild.WelcomeChannels] welcome_channels: A list of welcome channels of the welcome screen.
    """
...
class Guild(DictSerializerMixin):
    ...
    :ivar typing.List[bunny.api.models.role.Role] roles: The list of roles in the guild.
    :ivar typing.List[bunny.api.models.message.Emoji] emojis: The list of emojis from the guild.
    :ivar typing.List[bunny.api.models.guild.GuildFeature] features: The list of features of the guild.
    ...
    :ivar typing.Optional[int] rules_channel_id: The channel ID of senpai's defined "rules" channel of the guild.
    ...
    :ivar typing.Optional[typing.List[bunny.api.models.presence.PresenceUpdate]] presences: The list of presences in the guild.
    ...
    :ivar typing.Optional[bunny.api.models.guild.WelcomeScreen] welcome_screen: The welcome screen of the guild.
    :ivar int nsfw_level: The NSFW safety filter level of the guild.
    :ivar typing.Optional[bunny.api.models.guild.StageInstance] stage_instances: The stage instance of the guild.
    :ivar typing.Optional[typing.List[bunny.api.models.message.Sticker]] stickers: The list of stickers from the guild.
    """
