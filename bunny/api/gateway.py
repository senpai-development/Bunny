...
class Heartbeat(Thread):
    ...
    :ivar bunny.api.gateway.WebSocket ws: The WebSocket class to infer on.
...
class WebSocket:
    ...
    :ivar bunny.api.models.intents.Intents intents: An instance of :class:`bunny.api.models.Intents`.
    :ivar asyncio.AbstractEventLoop loop: The coroutine event loop established on.
    :ivar bunny.api.http.Request req: An instance of :class:`bunny.api.http.Request`.
    :ivar bunny.api.dispatch.Listener dispatch: An instance of :class:`bunny.api.dispatch.Listener`.
    ...
    :ivar bunny.api.gateway.Heartbeat keep_alive: An instance of :class:`bunny.api.gateway.Heartbeat`.
    :ivar bool closed: The current connection state.
    :ivar bunny.api.http.HTTPClient http: The internal HTTP client used to connect to the gateway.
    ...
    def __init__(
        ...
        :type intents: bunny.api.models.Intents
    ...
    def contextualize(self, data: dict) -> object:
        ...
        #     context: object = getattr(__import__("bunny.context"), "InteractionContext")()
        ...
        #     context: object = getattr(__import__("bunny.context"), "ComponentContext")()
