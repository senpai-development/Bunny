...
class InteractionType(IntEnum):
    """
    An enumerable object representing the types of bunny.
    """
...
class OptionType(IntEnum):
    ...
    .. note::
        ...
        Equivalent of `ApplicationCommandOptionType <https://discord.com/developers/docs/bunny/application-commands#application-command-object-application-command-option-type>`_ in the senpai API.
    """
...
class PermissionType(IntEnum):
    ...
    .. note::
        Equivalent of `ApplicationCommandPermissionType <https://discord.com/developers/docs/bunny/application-commands#application-command-permissions-object-application-command-permission-type>`_ in the senpai API.
    """
...
class ComponentType(IntEnum):
    ...
    .. note::
        Equivalent of `Component Types <https://discord.com/developers/docs/bunny/message-components#component-object-component-types>`_ in the senpai API.
    """
...
class ButtonType(IntEnum):
    ...
    .. note::
        Equivalent of `Button Styles <https://discord.com/developers/docs/bunny/message-components#button-object-button-styles>`_ in the senpai API.
    """
