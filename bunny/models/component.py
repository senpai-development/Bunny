...
class SelectOption(DictSerializerMixin):
    ...
    :ivar typing.Optional[bunny.api.models.message.Emoji] emoji: The emoji used alongside the label of the select option.
...
class SelectMenu(DictSerializerMixin):
    ...
    :ivar dict _json: The dictionary representation of the object.
    :ivar bunny.enums.ComponentType type: The type of select menu.
    :ivar str custom_id: The customized "ID" of the select menu.
    :ivar typing.List[bunny.models.component.SelectOption] options: The list of select options in the select menu.
...
class Button(DictSerializerMixin):
    ...
    :ivar dict _json: The dictionary representation of the object.
    :ivar bunny.enums.ButtonType type: The type of button.
    :ivar bunny.enums.ButtonType style: The style of the button.
    :ivar str label: The label of the button.
    :ivar typing.Optional[bunny.api.models.message.Emoji] emoji: The emoji used alongside the laebl of the button.
...
class Component(DictSerializerMixin):
    ...
    :ivar dict _json: The dictionary representation of the object.
    :ivar typing.Union[bunny.models.ActionRow, bunny.models.Button, bunny.models.Menu] type: The type of component.
    ...
    :ivar typing.Optional[bunny.enums.ButtonType] style: The style of the component.
    :ivar typing.Optional[str] label: The label of the component.
    :ivar typing.Optional[bunny.api.models.message.Emoji] emoji: The emoji used alongside the label of the component.
    :ivar typing.Optional[str] url: The URl route/path of the component.
    :ivar typing.Optional[typing.List[bunny.models.Menu]] options: The "choices"/options of the component.
    :ivar typing.Optional[str] placeholder: The placeholder text/value of the component.
    :ivar typing.Optional[int] min_values: The minimum "options"/values to choose from the component.
    :ivar typing.Optional[int] max_values: The maximum "options"/values to choose from the component.
    :ivar typing.Optional[typing.Union[list, bunny.models.ActionRow, typing.List[bunny.models.ActionRow]]] components: A list of components nested in the component.
    """
