...
class Option(DictSerializerMixin):
    ...
    :ivar bunny.enums.OptionType type: The type of option.
    ...
    :ivar typing.Optional[typing.List[bunny.models.Choice]] choices: The list of choices to select from.
    :ivar typing.Optional[list] options: The list of subcommand options included.
    :ivar typing.Optional[typing.List[bunny.api.models.channel.ChannelType] channel_type: Restrictive shown channel types, if given.
    """
...
class Permission(DictSerializerMixin):
    ...
    :ivar bunny.enums.PermissionType type: The type of permission.
...
class ApplicationCommand(DictSerializerMixin):
    ...
    :ivar typing.Optional[typing.List[bunny.models.Option]] options: The "options"/arguments of the application command.
